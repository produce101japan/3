...
function getTableEntryHTML(trainee, selected) {
  ...
  <div class="trainee_picker__container__entry ${eliminated}" data-id="${trainee.id}">
    ...
    <div class="trainee_picker__container__entry-text">
      ...
      <div class="info">
        <span class="name sub">${trainee.birth} ${trainee.birthplace} ${trainee.height}cm <a target="_blank" class="profile_link" href="${`https://produce101.jp/profile/detail/?id=${trainee.detail_id}`}" onclick="event.stopPropagation();">Profile   <i class="fa-solid fa-up-right-from-square"></i>
</a> </span>
      </div>
    </div>
  </div>`;
